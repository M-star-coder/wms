<template>
    <div v-loading="loading" class="main">
        <el-tabs v-model="tabType">
            <el-tab-pane label="仓库详情" name="infoDetail"></el-tab-pane>
        </el-tabs>
        <div v-if="tabType == 'infoDetail'">
            ...
            <div class="item">
                <el-row>
                    <el-col :span="12">
                        <label class="sublab">仓库编号：</label>{{detail.warehouseCode}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">仓库状态：</label>
                        <label :class="detail.lockStatus==1?'status s3':'status s1'"></label>
                        {{detail.lockStatus==1?"正常":"锁定"}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">仓库名称：</label>{{detail.warehouseName}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">所属公司：</label>{{detail.companyName}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">所属部门：</label>{{detail.deptName}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">负责人：</label>{{detail.managerName}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">负责人电话：</label>{{detail.telephone}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">仓库类型：</label>{{detail.categoryName}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">是否虚拟仓：</label>{{detail.isVirtual==1?"是":"否"}}
                    </el-col>
                    <el-col :span="12">
                    ...
                    <el-col :span="24">
                        <label class="sublab">仓库地址：</label>{{detail.address}}
                    </el-col>
                    <el-col :span="24">
                        <label class="sublab">
                            <span class="remarks">
...
export default {
    ...
    created(){
        if(this.$route.query.warehouseCode){
            this.getDetail();
        }
    },
    methods: {
        ...
        goEdit(){
            this.$router.push({ 
                ...
                query: {
                    type: 1,
                    warehouseCode: this.detail.warehouseCode,
                }
            });
        },
        // 返回
