    ...
    <div v-loading="loading" class="main">
        ...
        <div v-if="tabType == 'infoDetail'">
            ...
            <div class="item">
                <el-row>
                    <el-col :span="12">
                        <label class="sublab">库区编号：</label>{{detail.zoneCode}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">库区状态：</label>
                        <label :class="detail.lockStatus==1?'status s3':'status s1'"></label>
                        {{detail.lockStatus==1?"正常":"锁定"}}
                    </el-col>
                    <el-col :span="12">
                        <label class="sublab">库区名称：</label>{{detail.zoneName}}
                    </el-col>
                    <el-col :span="12">
