<template>
    <div v-loading="loading" class="main">
        <el-tabs v-model="tabType">
            <el-tab-pane label="客户详情" name="infoDetail"></el-tab-pane>
        </el-tabs>
        <div v-if="tabType == 'infoDetail'">
            ...
            <div class="item">
                <el-row>
                    <el-col :span="8">
                        <label class="sublab">客户编号：</label>{{detail.companyCode}}
                    </el-col>
                    <el-col :span="16">
                        <label class="sublab">客户名称：</label>{{detail.companyName}}
                    </el-col>
                    <el-col :span="8">
                        <label class="sublab">客户简称：</label>{{detail.companyAbbr}}
                    </el-col>
                    <el-col :span="8">
