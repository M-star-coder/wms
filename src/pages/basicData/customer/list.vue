        ...
        <div class="searchinfo">
            ...
            <div class="search">
                <el-form :inline="true" align="left">
                    <el-form-item>
                        <el-input v-model="params.companyName" placeholder="客户名称" size="small"></el-input>
                    </el-form-item>
                </el-form>
                <div class="searchbtn">
        ...
        <div class="listinfo">
            <div class="tablestyle">
                <el-table v-loading="loading" :data="listData" border size="medium" style="width: 100%">
                    <el-table-column fixed prop="companyCode" label="编码" :show-overflow-tooltip="true" min-width="170px" align="center"></el-table-column>
                    <el-table-column prop="companyName" label="客户名称" :show-overflow-tooltip="true" min-width="220px" align="left"></el-table-column>
                    <el-table-column prop="companyAbbr" label="简称" :show-overflow-tooltip="true" min-width="140px" align="left"></el-table-column>
                    ...
                    <el-table-column prop="companyAddr" label="地址" :show-overflow-tooltip="true" min-width="180px" align="center"></el-table-column>
...
export default {
    ...
    methods: {
        ...
        dataDetail (data) {
            this.$router.push({ 
                path: "/main/basicData/customer/detail", 
                query: {
